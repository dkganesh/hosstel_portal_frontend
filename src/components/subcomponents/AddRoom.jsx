        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto ">
          <div className="flex min-h-full items-center justify-center p-4 ">
            ...
            >
              ...
              <input type="number" name="roomNumber" id="std_login_email"  required placeholder="Room Number" className='border-2 border-gray-600 mx-2 w-full rounded-md px-3 min-h-9 placeholder:font-light placeholder:text-black mb-3' value={room.roomNumber} onChange={handleChange}/>
