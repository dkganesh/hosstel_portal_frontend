...
export const HostelManagemet = () => {
  ...
  return (
    <div className='w-full  flex flex-wrap items-center p-2 justify-center'>
        ...
        <button className='font-extralight px-2 py-1 bg-slate-300 rounded-md mb-3 hover:bg-slate-500 border-2 border-slate-500 mr-2 cursor-not-allowed'>Add Block</button>
        ...
        <button className='font-extralight px-2 py-1 bg-slate-300 rounded-md mb-3 hover:bg-slate-500 border-2 border-slate-500 mr-2 cursor-not-allowed'>Pass Details</button>
