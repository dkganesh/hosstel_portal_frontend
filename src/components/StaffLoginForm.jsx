...
import {addInputs as addStudent} from '../slices/Student_Login_Slice'
...
export const StaffLoginForm = () => {
  ...
  async function handleSubmit(e){
    e.preventDefault();
    const link=SERVER_URL+"/staffLogin"
  ...
  return (
        <div className="h-[98vh] w-[98vw] flex ">
          ...
          <form action="" className='flex flex-col items-center justify-evenly' onSubmit={handleSubmit}>
            <h3 className='text-center font-thin text-lg py-1 px-2'>Staff Login</h3>
